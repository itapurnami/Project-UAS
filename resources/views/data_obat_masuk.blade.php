...
<div class="content-wrapper">
  ...
  <div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0"><span class="fa fa-pen"></span> Input Data Obat Masuk</h1>
        </div><!-- /.col -->
        <div class="col-sm-6">
            ...
            <div class="card-body"> 
              <form class="form-horizontal">
                <div class="card-body">
                  ...
                  <div class="form-group row">
                    <label for="status" class="col-sm-2 col-form-label text-md-right">Tanggal Masuk :</label>
                    <div class="col-sm-6">
                      <div class="input-group date" id="date_masuk" data-target-input="nearest">
                          <input type="text" class="form-control datetimepicker-input form-control-border border-width-1" data-target="#date_masuk"/>
                          <div class="input-group-append" data-target="#date_masuk" data-toggle="datetimepicker">
