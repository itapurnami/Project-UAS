            ...
            <div class="card-body"> 
              <form class="form-horizontal">
                <div class="card-body">
                  ...
                  <div class="form-group row">
                    <label for="jenis_obat" class="col-sm-2 col-form-label text-md-right">Email :</label>
                    <div class="col-sm-6">
                  ...
                  <div class="form-group row">
                    <label for="jenis_obat" class="col-sm-2 col-form-label text-md-right">Konfirmasi Password :</label>
                    <div class="col-sm-6">
                      <input type="text" class="form-control form-control-border border-width-1" id="jenis_obat">
                    </div>
                  </div>
